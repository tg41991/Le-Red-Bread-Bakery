 ...
 * Plugin URI:        http://localhost/leredbread/
 * Description:       A business hours widget for the Le Red Bread bakery.
 * Version:           1.0.0
 * Author:            Tomas
 * Author URI:				http://localhost/leredbrea/
 * License:           GPL-2.0+
...
class  LRB_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'LRB_Hours';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add the bakery business hours.'
			)
		);
